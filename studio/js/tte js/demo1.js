 ...
 */
{
    class TextFX {
        constructor(el) {
            this.DOM = {el: el};
            // The texts (repeated)
            this.DOM.texts = [...this.DOM.el.querySelectorAll('.content__txt')];
    ...
    class Slide {
        constructor(el) {
            ...
            this.textFX = new TextFX(this.DOM.el.querySelector('.content__txt-wrap'));
        }
    ...
    new Slideshow(document.querySelector('.vision'));
